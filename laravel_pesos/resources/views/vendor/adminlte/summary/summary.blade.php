...
@section('main-content')
    ...
    <tr>
        ...
        @endif
        <td>{{ number_format($summarys->amount, 2, '.', ',') }} MXN</td>
...
@endforeach
    ...
    <div class="small-box box">
        <div class="inner">
            <h1> {{ number_format($totalfinal, 2, '.', ',') }} MXN</h1>
            <p>Pesos Mexicanos</p>
        </div>
        <div class="icon">
...
<div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <h4 class="box-title"><strong>Servicio para observacion de los movimiento <br></strong></h4><br> <!-- Añadido "strong" para negritas -->
<p class="box-subtitle"><br>

Nuestro servicio proporciona una herramienta eficaz para la
 observación detallada de tus movimientos financieros. 
 Con la capacidad de analizar cada transacción, podrás revisar
  de manera exhaustiva los detalles asociados, como Tipo de Movimiento, Concepto, 
  Motivo, Monto, Impuesto, Número de Referencia, Número de Control, Categorías, 
  Cuentas y Fecha. Esta función te permite tener una visión completa y clara de tus a
  ctividades financieras, facilitando la toma de decisiones informadas 
y el seguimiento preciso de tu situación financiera. 
</p>
<br>
