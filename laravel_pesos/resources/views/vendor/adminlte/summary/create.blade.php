      ...
      <button  style=" margin: 15px;" type="button" id="closemodal2" class="btn btn-default" data-dismiss="modal">Ok</button>
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <h4 class="box-title"><strong>Servicio para registro de nuevo movimiento <br></strong></h4><br> <!-- Añadido "strong" para negritas -->
<p class="box-subtitle"><br>

Nuestro software ofrece un servicio eficiente para el registro de nuevos movimientos
financieros, facilitando el proceso a través de la clasificación por Tipo de Movimiento. 
Simplemente elige el Tipo de Movimiento, selecciona la categoría correspondiente, 
introduce el concepto y motivo del movimiento, así como los montos y posibles impuestos 
asociados. Además, podrás asignar un Número de Referencia y de Control para un seguimiento 
más preciso. Con la opción de seleccionar la fecha del movimiento y la cuenta específica, 
nuestro software brinda una experiencia intuitiva y organizada para un registro financiero 
detallado y fácil de manejar. 
</p>
<br>
